...
export default {
  editor: {
    ...
    customSettingsPropertiesOrder: [
      ...
      ["scaleControl", "layerControl", "locationControl"],
      ["clusterMarkers", "clusterRadius"],
      [
        "markerTitle",
        "markers",
        "markerDataField",
  ...
  properties: {
    ...
    locationControl: {
      label: { en: "Show location control" },
      type: "OnOff",
      section: "settings",
      defaultValue: false,
      bindable: true,
    ...
    clusterMarkers: {
      label: { en: "Enable marker clustering" },
      type: "OnOff",
      section: "settings",
      defaultValue: false,
      bindable: true,
    ...
    clusterRadius: {
      ...
      defaultValue: 80,
      bindable: true,
      hidden: (content) => !content.clusterMarkers,
      options: {
        min: 10,
        max: 200,
        step: 1,
